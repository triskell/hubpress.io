...
Flutter scrolling widgets are impressive, there are lots of things behind it from views to controllers or physics. You will get in this talk an overview of this huge part of Flutter, and learn how to make simple or customs scrolling views.
