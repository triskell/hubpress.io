...
- https://www.youtube.com/watch?v=Sk9ZMIQDpUg[Day 1]
- https://www.youtube.com/watch?v=4lLI-hZvGg0[Day 2]

==== Tim Sneath's keynote

A quick presentation of Flutter, at first.

He spoke about Dart and why they used it: hot reload, native compilation, language optimisation, open source, ECMA standard.
