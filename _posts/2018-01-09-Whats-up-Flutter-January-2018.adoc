...
States in Flutter are not that easy to use : Stateful Widgets are great, but it can be hard to maintain. InheritedWidgets can solve a part of this, but it is not that optimised. Setting up tests can be hard with in some cases, too.

A solution is to use layers : TODO 51:00
...
- https://www.dotnetrocks.com/?show=1513[Flutter with Tim Sneath and Adam Barth] a podcast by the _.Net Rocks!_ podcast.
